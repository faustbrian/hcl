...
final class GenericParser
{
     ...
     * @throws ParserException      If the element is invalid
     */
     ...
     *
     * @throws ParserException If the token isn't an identifier or keyword
     * @return Token           The consumed token
     */
    private function consumeIdentifierOrKeyword(): Token
    {
        ...
        if ($this->isAtEnd()) {
            throw ParserException::unexpectedEof('identifier');
        }

        throw ParserException::unexpectedToken($token, 'identifier');
    }
