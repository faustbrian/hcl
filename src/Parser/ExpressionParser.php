...
final class ExpressionParser
{
     ...
     *
     * @return int The current position in the token stream
     */
     ...
     *
     * @param int $position The new position in the token stream
     */
     ...
     *
     * @throws UnexpectedTokenException If invalid syntax
     * @return mixed                    The evaluated result
     */
    private function parsePrimary(): mixed
    {
        ...
        return match ($token->type) {
            ...
            default => throw UnexpectedTokenException::at($token, 'expression'),
        };
    }
    ...
    private function evaluateBinary(mixed $left, TokenType $operator, mixed $right): mixed
    {
        return match ($operator) {
            ...
            default => throw UnexpectedTokenException::at(
     ...
     *
     * @return float|int The parsed number (int if no decimal point, float otherwise)
     */
     ...
     *
     * @return bool The parsed boolean value (true or false)
     */
     ...
     *
     * @return Token The previous token (before advancing)
     */
     ...
     * @param  string                       $expected Description of what was expected (for error messages)
     * @throws UnexpectedEndOfFileException If reached end of file
     * @throws UnexpectedTokenException     If the token doesn't match
     ...
     *
     * @return bool True if at the end of the token stream
     */
     ...
     * @return float The float representation (0.0 if not convertible)
     */
